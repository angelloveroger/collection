    ...
    <div class="layui-container">
        <div class="layui-row">
            <ul class="nav-list">
                ...
                <li class="on"><a href="<?=links('hot','news')?>">最新更新</a><em></em></li>
