...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('agent/card/index/json')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'cion'}" lay-filter="cion">
              <thead>
                <tr>
                ...
                <?php }else{ ?>
                    ...
                    <th lay-data="{field:'endtime',align:'center',width:160}">到期时间</th>
                <?php } ?>
                </tr>
              </thead>
            </table>
...
<script>
    function get_dc(){
        ...
        if(ids.length == 0){
            ...
            window.location.href = '<?=links('agent/card/daochu')?>?id='+ids.join(',');
        }
    }
</script>
</body>
