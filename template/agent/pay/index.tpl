...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('agent/pay/index/json')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'pay'}" lay-filter="pay">
              <thead>
                <tr>
