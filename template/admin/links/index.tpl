...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-body">
            ...
            <table class="layui-table" lay-even lay-skin="row" lay-data="{url:'<?=links('links/index/json')?>',limit:20,limits:[20,30,50,100,500],page:{layout:['count','prev','page','next','refresh','skip','limit']},id:'admin'}" lay-filter="admin">
              <thead>
                <tr>
...
<script type="text/html" id="cmdTpl">
    <button title="编辑" class="layui-btn layui-btn-xs" onclick="Admin.open('链接编辑','<?=links('links/edit')?>/{{d.id}}',500,230)"><i class="layui-icon">&#xe642;</i>编辑</button>
    <button title="删除" class="layui-btn-danger layui-btn layui-btn-xs" onclick="Admin.del('<?=links('links/del')?>','{{d.id}}',this)" href="javascript:;" ><i class="layui-icon">&#xe640;</i>删除</button>
</script>
</body>
</html>