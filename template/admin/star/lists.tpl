            ...
            <for class="layui-form toolbar">
                <div class="layui-form-item" style="margin-top: 10px;">
                    <div class="layui-inline">
                        ...
                        <button class="layui-btn icon-btn layui-btn-sm layui-btn-normal" onclick="Admin.open('新增分类','<?=links('star/lists_edit')?>',400,300);"><i class="layui-icon">&#xe624;</i>新增分类</button>
                    </div>
                </div>
                <table class="layui-table" lay-skin="line">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>标题</th>
                            <th class="hide" style="text-align:center">演员数量</th>
...
layui.use(['form','layer'],function() {
    ...
    form.on('submit(edit)', function(data){
        ...
        data.field.ids = ids;
        $.post('<?=links('star/lists_update')?>', data.field, function(res) {
            if(res.code == 1){
    ...
    form.on('submit(del)', function(data){
        ...
        layer.confirm('确定要删除吗', {
            ...
            $.post('<?=links('star/lists_del')?>', {id:ids}, function(res) {
                if(res.code == 1){
                    layer.msg(res.msg,{icon: 1});
                    setTimeout(function() {
                        window.location.reload();
