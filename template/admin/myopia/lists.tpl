            ...
            <for class="layui-form toolbar">
                <div class="layui-form-item" style="margin-top: 10px;">
                    <div class="layui-inline">
                        ...
                        <button class="layui-btn icon-btn layui-btn-sm layui-btn-normal" onclick="Admin.open('新增分类','<?=links('myopia/lists_edit')?>',400,300);"><i class="layui-icon">&#xe624;</i>新增分类</button>
                    </div>
                </div>
                <table class="layui-table" lay-skin="line">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="hide" style="text-align:center">短视数量</th>
...
layui.use(['form','layer'],function() {
    ...
    form.on('submit(del)', function(data){
        ...
        layer.confirm('确定要删除吗', {
            ...
            $.post('<?=links('myopia/lists_del')?>', {id:ids}, function(res) {
                if(res.code == 1){
