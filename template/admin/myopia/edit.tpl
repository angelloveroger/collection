...
<div class="layui-fluid">
    <form class="layui-form layui-form-pane" action="<?=links('myopia/save')?>">
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md8">
                <label class="layui-form-label">短视分类</label>
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md8">
                <label class="layui-form-label">短视图片</label>
                <div class="layui-input-block">
                    <input type="text" name="pic" class="layui-input" value="<?=$pic?>" placeholder="请输入短视图片地址">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md4">
        ...
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md8">
                ...
                <div class="layui-input-block">
                    <input type="text" name="upic" class="layui-input" value="<?=$upic?>" placeholder="请输入用户头像地址">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md4">
                <label class="layui-form-label">用户昵称</label>
                <div class="layui-input-block">
                    <input type="text" name="nickname" class="layui-input" value="<?=$nickname?>" placeholder="请输入用户昵称">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-col-xs12 layui-col-md3">
                ...
                <div class="layui-input-block">
                    <input type="number" name="share" class="layui-input" value="<?=$share?>" placeholder="请输入分享次数">
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md3">
            ...
            <div class="layui-col-xs12 layui-col-md3">
                ...
                <div class="layui-input-block">
                    <select name="tid">
                        ...
                        <option value="1"<?php if($tid == 1) echo 'selected';?>>是</option>
                    </select>
                </div>
            </div>
            <div class="layui-col-xs12 layui-col-md3">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">短视内容</label>
            <div class="layui-input-block">
                <textarea id="text" name="text" placeholder="短视内容" class="layui-textarea" style="min-height:100px;"><?=$text?></textarea>
            </div>
        </div>
