(function($) {
    ...
    var videoSpeed = 1;
    var videoListAll = new Array('https://vd3.bdstatic.com/mda-mjcycg7gi6fvymag/sc/cae_h264/1634169155272117672/mda-mjcycg7gi6fvymag.mp4',
        'https://vd4.bdstatic.com/mda-kget6u3u3wth2yjy/hd/mda-kget6u3u3wth2yjy.mp4');
    var danId = 0;
    var clickFlag = null;
    var vedioError = null;
    function qiehuan(){
    ...
    function danOn() {
        ...
        if (danText && !(isK.test(danText))){
            ...
            if(danId %3 == 1){
                $('#' + danIdNow).css('margin-top','20px');
            } else if(danId % 3 == 2){
                $('#' + danIdNow).css('margin-top','40px');
            }
            if(video[0].paused || video[0].ended){
                $('.psVideo-dan-all').css('animation-play-state','paused');
            } else {
