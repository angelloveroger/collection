...
class Update extends My_Controller {
	...
	public function index(){
		...
		if ($this->yhzip->extract(PCLZIP_OPT_PATH, FCPATH, PCLZIP_OPT_REPLACE_NEWER) == 0) {
            unlink($file_zip);
	...
	public function msg($txt,$zt=0){
		$color = $zt == 0 ? 'red' : '#080';
		echo '<link rel="stylesheet" href="/packs/admin/css/style.css"><div style="padding:50px;"><fieldset class="layui-elem-field"><legend><b>更新状态</b></legend><div class="layui-field-box" style="color:'.$color.';font-size:16px;">'.$txt.'</div></fieldset></div>';
		if($zt == 1){
